...
public class PlaneAdapter extends RecyclerView.Adapter<PlaneAdapter.ViewHolder>{
    ...
    public PlaneAdapter (ArrayList<String> dataSet) {
    ...
    public PlaneAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull PlaneAdapter.ViewHolder holder, int position) {
