...
public class LifeAdapter extends RecyclerView.Adapter<LifeAdapter.ViewHolder>{
    ...
    public LifeAdapter(ArrayList<String> dataSet) {
    ...
    public LifeAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        LifeAdapter.ViewHolder viewHolder = new LifeAdapter.ViewHolder(view);

        return viewHolder;
    }

    @Override   // ViewHolder안의 내용을 position에 해당되는 데이터로 교체한다.
    public void onBindViewHolder(@NonNull LifeAdapter.ViewHolder holder, int position) {
